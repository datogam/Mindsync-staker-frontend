  ...
  useEffect(() => {
    ...
    const loadPosition = async (
      ...
      try {
        ...
        console.log('reward', rewardNumber, reward);
        let secondsInside = toBigNumber(secondsInsideX128.toString());
        console.log('secondsInsideX128', secondsInsideX128, secondsInside);

        const [
          rewardMAI,
          rewardETH,
        ] = await stakingRewardsContract.getMindsyncRewardInfo(
          currentIncentive.key,
          tokenId
        );
        console.log('REWARD');
        console.log('rewardMAI', rewardMAI);
        console.log('rewardETH', rewardETH);
